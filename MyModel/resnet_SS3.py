...
class resnet_SS3(nn.Module):
    ...
    def __init__(self,
                 ...
                 groups=1,
                 width_per_group=64):
        super(resnet_SS3, self).__init__()
...
def resnet_SS3_(num_classes=200, include_top=True):
    return resnet_SS3(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, include_top=include_top)
