...
class Dropout_BN(nn.Module):
    ...
    def __init__(self,
                 ...
                 groups=1,
                 width_per_group=64):
        super(Dropout_BN, self).__init__()
...
def Dropout_BN_(num_classes=200, include_top=True):
    return Dropout_BN(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, include_top=include_top)
